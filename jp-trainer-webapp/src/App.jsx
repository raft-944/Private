...
**没查出文体问题时,explanation 里一个关于文体的字都不许出现。**不许写"文体统一""虽未用敬体""该句型本身不带文体限制""文体没有问题"这类话——哪怕是肯定的说法也不行。这条检查是给你自己判卷用的,不是讲评要交代的内容;学生只想知道这道题他哪里写得好、哪里该改,不想知道你检查过哪些清单。(顺带记牢:「〜ます」「〜です」结尾的句子**就是敬体**,不要把它说成"未用敬体"。)`;
